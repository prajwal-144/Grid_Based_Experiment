...
if __name__ == '__main__':
    ...
    train_dataloader = torch.utils.data.DataLoader(train_dataset,shuffle=True,batch_size=BATCH_SIZE,num_workers=0)#min(8, os.cpu_count()))
    val_dataloader = torch.utils.data.DataLoader(val_dataset,shuffle=True,batch_size=BATCH_SIZE,num_workers=0)#min(8, os.cpu_count()))
